...
def resnet18(pretrained: bool = False, progress: bool = True,
    ...
    """
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, pretrained_path, progress,
                   **kwargs)
...
def resnet34(pretrained: bool = False, progress: bool = True,
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, pretrained_path, progress,
                   **kwargs)
...
def resnet50(pretrained: bool = False, progress: bool = True,
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, pretrained_path, progress,
                   **kwargs)
...
def resnet101(pretrained: bool = False, progress: bool = True,
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet101', Bottleneck, [3, 4, 23, 3], pretrained, pretrained_path, progress,
                   **kwargs)
...
def resnet152(pretrained: bool = False, progress: bool = True,
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet152', Bottleneck, [3, 8, 36, 3], pretrained, pretrained_path, progress,
                   **kwargs)
...
def resnext50_32x4d(pretrained: bool = False, progress: bool = True,
    ...
    return _resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pretrained, pretrained_path, progress, **kwargs)
